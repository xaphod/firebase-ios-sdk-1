...
readonly NANOPB_TEMPDIR="${DIR}/Firebase/Messaging/nanopb_temp"

readonly LIBRARY_DIR="${DIR}/Firebase/Messaging/"
readonly PROTO_DIR="${DIR}/Firebase/Messaging/ProtoSupport/Protos/"
...
python "${DIR}/Firebase/Messaging/ProtoSupport/proto_generator.py" \
  --nanopb \
